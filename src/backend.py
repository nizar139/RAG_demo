...
def get_llm(llm_provider: str, model_repo: str) -> Any:
...
def retrieve_context_with_context_limit(
    query: str, token_limit: int = TOKEN_LIMIT
...
def prompt_with_context(request: ModelRequest) -> str:
    ...
    content, _ = retrieve_context_with_context_limit(
        last_query, token_limit=TOKEN_LIMIT
    )
...
class SimpleRAG:
    def __init__(self, llm_provider: str, model_repo: str, verbose: bool = False):
